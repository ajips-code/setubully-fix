...
<div class="col-12 col-sm-5 bg pt-3">
    ...
    <div class="text-center illus-login">
        <img src="{{ asset('images/illust.png') }}" alt="logo" style="width: 60%; display: block; margin: 0 auto;">
    </div>
</div>
        ...
        <div class="card-body">
            <form action="/login" method="post" class="">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control p-2 mt-1 @error('username') is-invalid @enderror" id="username" name="username" value="{{ old('username') }}" />
                    @error('username')
                ...
                <div class="mb-5">
                    ...
                    <div class="d-flex flex-row-reverse align-items-center" id="wrapper">
                        <input type="password" class="form-control p-2 mt-1 @error('password') is-invalid @enderror" id="password" name="password" />
                        <button type="button" class="btn bg-transparent show-password" id="show-btn" data-bs-toggle="tooltip" data-bs-title="Tampilkan / Sembunyikan password">
